...
<div class="dashboard d-flex flex-column align-items-start align-self-stretch" style="gap: 30px;">
    <div class="dashboard-card d-flex align-items-center align-self-stretch" style="gap: 20px;">
        ...
        <div class="card">
            ...
            <div class="card-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 16 15" fill="none">
                    <path d="M16 11.333C15.9978 13.1729 14.5069 14.6636 12.667 14.666H3.33301C1.49313 14.6636 0.00221861 13.1729 0 11.333V5.32715L16 5.25293V11.333ZM5.01855 0C5.32884 0.00025 5.63534 0.072625 5.91309 0.210938L8.0166 1.2666C8.10954 1.3111 8.21143 1.33366 8.31445 1.33301H12.667C14.2176 1.33626 15.5608 2.4087 15.9082 3.91992L0 3.99414V3.33301C0.00238285 1.49322 1.49325 0.00235161 3.33301 0H5.01855Z" fill="#111111"/>
                </svg>
            </div>
        </div>
    </div>
