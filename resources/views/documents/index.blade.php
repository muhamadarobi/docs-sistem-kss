...
@section('content')
    <div class="navbar d-flex justify-content-between align-items-center align-self-stretch bg-white">
        <div class="navbar-left d-flex align-items-center">
            <img src="https://placehold.co/120x35/0077C2/FFFFFF?text=KSS&font=inter" alt="KSS" style="height: 35px;">
            <div class="akun-title d-flex flex-column align-items-start">
                <span class="nama" style="font-size: 14px; font-weight: 600;">Selamat Pagi, Pak Surya</span>
                <span class="title" style="font-size: 10px; font-weight: 300;">Petugas Lapangan</span>
            </div>
        </div>
        <img src="https://placehold.co/35x35/0077C2/FFFFFF?text=S&font=inter" alt="User" style="height: 35px; border-radius: 50%;">
    </div>
